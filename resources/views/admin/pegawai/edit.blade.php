    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="font-semibold text-xl text-gray-800 mb-6 text-center">Edit Pegawai</h3>

                    <form method="POST" action="{{ route('pegawai.update', $pegawai->id) }}" class="w-full">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="{{ $pegawai->name }}" placeholder="Masukkan nama pegawai" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" required autocomplete="off" />
                                </div>

                                <div>
                                    <label for="nip" class="block font-medium text-gray-700 mb-2">NIP</label>
                                    <input type="number" name="nip" id="nip" value="{{ $pegawai->nip }}" placeholder="Masukkan NIP pegawai" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" required autocomplete="off" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="place_of_birth" id="place_of_birth" value="{{ $pegawai->place_of_birth }}" placeholder="Masukkan tempat lahir pegawai" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" required autocomplete="off" />
                                </div>

                                <div>
                                    <label for="date_of_birth" class="block font-medium text-gray-700 mb-2">Tanggal Lahir</label>
                                    <input type="date" name="date_of_birth" id="date_of_birth" value="{{ \Carbon\Carbon::parse($pegawai->date_of_birth)->format('Y-m-d') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" required autocomplete="off" />
                                </div>

                                <div>
                                    <label for="phone_number" class="block font-medium text-gray-700 mb-2">Nomor Telepon</label>
                                    <input type="number" name="phone_number" id="phone_number" value="{{ $pegawai->phone_number }}" placeholder="Masukkan nomor telepon pegawai" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" required autocomplete="off" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="address" id="address" value="{{ $pegawai->address }}" placeholder="Masukkan alamat pegawai" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" required autocomplete="off" />
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="position" id="position" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm">
                                        <option value="Dokter" {{ $pegawai->position == 'Dokter' ? 'selected' : '' }}>Dokter</option>
                                        <option value="Petugas Pendaftaran" {{ $pegawai->position == 'Petugas Pendaftaran' ? 'selected' : '' }}>Petugas Pendaftaran</option>
                                        <option value="Kasir" {{ $pegawai->position == 'Kasir' ? 'selected' : '' }}>Kasir</option>
                                        <option value="Lainnya" {{ $pegawai->position == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                                </div>

                                <div>
                                    <label for="specialization" class="block font-medium text-gray-700 mb-2">Spesialisasi</label>
                                    <input type="text" name="specialization" id="specialization" value="{{ $pegawai->specialization }}" placeholder="Kosongkan jika bukan dokter" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" autocomplete="off" />
                                </div>
                            </div>
                        </div>
