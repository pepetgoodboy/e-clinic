    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="font-semibold text-lg text-gray-800 mb-6 text-center">Edit Wilayah</h3>

                    <form method="POST" action="{{ route('wilayah.update', $wilayah->id) }}" class="max-w-2xl mx-auto">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex gap-3">
                                <input type="text" name="name" id="name" class="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" required autocomplete="off" value="{{ $wilayah->name }}" placeholder="Masukkan nama wilayah" />
