        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 flex flex-col justify-center items-center gap-4">
                    <img src="{{ asset('img/403.png') }}" alt="403" class="w-full max-w-xs h-auto mx-auto" />
                    <h2 class="text-2xl sm:text-3xl font-bold text-center">Anda tidak memiliki akses untuk halaman ini.</h2>
