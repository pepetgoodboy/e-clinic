                        ...
                        <table class="min-w-full divide-y divide-gray-200 rounded-lg shadow-md">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-center text-xs font-bold text-gray-700 uppercase tracking-wider">Diagnosis</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">{{ $pasien->complaint }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">{{ $pasien->diagnosis }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center space-x-2">
                                        <a href="{{ route('dokter.periksa.create', $pasien) }}" class="inline-block px-3 py-1.5 bg-blue-500 text-white text-xs font-semibold rounded-md hover:bg-blue-600">
                                            <i class="fa-solid fa-stethoscope"></i> Periksa Pasien
                                        </a>
                                ...
                                @empty
                                <tr>
                                    <td colspan="8" class="px-6 py-4 text-center text-gray-500">Data pasien tidak ditemukan.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
